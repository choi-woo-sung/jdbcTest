...
public static void main(String[] args) {
	/*
	 ...
	 2.접속하기 : 접속이 성공하면 Connection객체가 생성된다.
	 	DriverManager.getConnetcion()메서드를 이용한다.
	...
	try {
		...
		// 4. SQL 문을 Statement 객체를 이용하여 실행하고 실행결과를 Result에 저장한다.
		String sql = "select * from lprod"; //실행할 SQL 문
		
		//SQL문이 select일경우에는 excuteQuery()메서드 이용하고,
		// 		 insert ,upadte, delete 일 경우에는 executeUpdate()메서드 이용함.
